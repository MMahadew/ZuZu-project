    ...
    <form action="index.php?page=cart" method="post">
        <table>
            ...
            <?php if (empty($products)): ?>
                <tr>
                    <td colspan="5" style="text-align:center;">Winkelwagen is leeg</td>
                </tr>
            <?php else: ?>
        ...
        <div class="subtotal">
            <span class="text">Totaal Prijs</span>
            <span class="price">&euro;<?=$subtotal?></span>
        </div>
        <div class="buttons">
            <input type="submit" value="Update" name="update">
            <input type="submit" value="Plaats Bestelling" name="placeorder">
        </div>
    </form>
</div>
